...
import { standardErrors, formatErrorMessage } from '../../../src/utils/error-messages.js';
...
describe('standardErrors', () => {
	...
	describe('apiError', () => {
		...
		it('should include details when provided', () => {
			const result = standardErrors.apiError('mcp/execute', 500, 'Connection refused');
	...
	describe('unsupported', () => {
		...
		it('should include reason when provided', () => {
			const result = standardErrors.unsupported('batch delete', 'Not implemented yet');
	...
	describe('configurationError', () => {
		...
		it('should include working directory when provided', () => {
			const result = standardErrors.configurationError('Parse error', '/home/user/project');
