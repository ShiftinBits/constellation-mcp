...
**See**: `../AGENTS.md` for workspace architecture and shared types.
...
**Adding types**: Add to `constellation-types/src/`, not locally. See `../AGENTS.md` Section 3.
...
| Limit             | Value                                                         |
| ----------------- | ------------------------------------------------------------- |
| Default timeout   | Dynamic — AST-weighted per call (parse-failure fallback: 30s) |
...
| Path                    | Content                              |
| ----------------------- | ------------------------------------ |
| `../AGENTS.md`          | Workspace architecture, shared types |
